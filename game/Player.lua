  ...
  return {
    ...
    draw = function(self)
      ...
      if self.thrusting then
        ...
        self:drawFlameThrust("fill", { 355 / 255, 102 / 255, 25 / 255 })
      ...
      love.graphics.polygon(
        "line",
        self.x + ((4 / 3) * self.radius) * math.cos(self.angle), -- tip of the triangle
        self.y - ((4 / 3) * self.radius) * math.sin(self.angle),
        self.x - self.radius * (2 / 3 * math.cos(self.angle) + math.sin(self.angle)), -- bottom left
        self.y + self.radius * (2 / 3 * math.sin(self.angle) - math.cos(self.angle)),
        self.x - self.radius * (2 / 3 * math.cos(self.angle) - math.sin(self.angle)), -- bottom right
        self.y + self.radius * (2 / 3 * math.sin(self.angle) + math.cos(self.angle))
      )
    end,
    ...
    movePlayer = function(self)
      ...
      if self.thrusting then
        ...
        self.thrust.y = self.thrust.x - self.thrust.speed * math.sin(self.angle) / FPS
      else
